...
function BackgroundSunshine (props) {
    useEffect(() => {
        var canvas, c, w, h,
        twoPI = Math.PI * 2,
        mX, mY,
    ...
    per = { x: w/2, y: h/8, step: 1 }
        mtn = new Mountains(50,"100");
    ...
    this.draw = function(){
        ...
        c.fillStyle = "rgba("+(h-mY)+","+(h-mY)+","+(h-mY)+",0.18)";
...
export default BackgroundSunshine;
